...
# Featured Movie
movie1 = Movie.create(title: "Ruby On Rails Mini Curso ", description: "Aprenda a criar uma API completa com Ruby On Rails...", thumbnail_key: "onebitflix.png", thumbnail_cover_key: "onebitflix.png", video_key: "onebitflix.mp4", highlighted: true, category: ror, featured_thumbnail_key: "onebitflix.png")
...
# Movies sem série
movie2 = Movie.create(title: "Rede Social", description: "O Docker é um plataforma (aberta) que permite que você crie, rode e faça deploy de containers. De maneira simples, um container é o empacotamento dasua aplicação mais as dependências dela para criar uma rede social", thumbnail_key: "rede-social.png", thumbnail_cover_key: "docker-cover.png", video_key: "rede-social.mp4", category: outros)
movie3 = Movie.create(title: "Visual Studio", description: "Uma série completa para você dominar um dos mais importantes editores de texto.", thumbnail_key: "atom.png", thumbnail_cover_key: "visual-studio.png", video_key: "visual-studio.mp4", category: outros)
